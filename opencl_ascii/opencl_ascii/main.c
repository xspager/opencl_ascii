...
//  OpenCLFuck
//
//  Created by Daniel Lemos on 27/07/15.
//  Copyright (c) 2015 CodeRoot. All rights reserved.
//
#include <stdio.h>
#include <stdlib.h>
...
int main (int argc, const char * argv[]) {
    ...
    clGetDeviceInfo(gpu, CL_DEVICE_NAME, 64, name, NULL);
    ...
    char* test_in = (char*)malloc(sizeof(cl_char) * NUM_VALUES);
    ...
    char* test_out = (char*)malloc(sizeof(cl_char) * NUM_VALUES + 1); // + '\0'
    ...
    void* mem_in  = gcl_malloc(sizeof(cl_char) * NUM_VALUES, test_in,
                               CL_MEM_READ_ONLY | CL_MEM_COPY_HOST_PTR);
    
    // The output array is not initalized; we're going to fill it up when
    // we execute our kernel.                                             // 4
    void* mem_out =
    gcl_malloc(sizeof(cl_char) * NUM_VALUES, NULL, CL_MEM_WRITE_ONLY);
    ...
    dispatch_sync(queue, ^{
        ...
        size_t wgs;
        gcl_get_kernel_block_workgroup_info(brainfuck_kernel,
        ...
        brainfuck_kernel(&range,(cl_char*)mem_in, (cl_char*)mem_out);
        ...
        gcl_memcpy(test_out, mem_out, sizeof(cl_char) * NUM_VALUES);
